...
describe Person do
  ...
  context "When testing add_rental method" do
    it "should return array of unique rentals" do
      expect(person.add_rental(rental)) == [rental]
      expect(person.add_rental(rental)) == [rental]
    end
  end

  context "When testing rental_list method" do
    it "should return array of rental of that person" do
      expect(person.rental_list) == [rental]
    end
  end

  context "When testing to_hash method" do
    it "should return an object" do
      expect(person.to_hash) == { class: person.class, id:person.id, name: person.name, age: person.age, parent_permission: true }
    end
  end
